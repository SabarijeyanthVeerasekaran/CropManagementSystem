...
public class Register extends AppCompatActivity {
    ...
    void sendUserData()
    {
        ...
        DatabaseReference databaseReference1=firebaseDatabase.getReference("8NnkKBoihvgoo1FNcxy1kykfQfV2").child("8NnkKBoihvgoo1FNcxy1kykfQfV2").child(uid);
        UserProfile userProfile=new UserProfile(name,password,email,district);
